...
#define MHZ_10_IN_GPIO					(PIO_PB26_IDX)
#define MHZ_10_IN_PIO_ID				ID_PIOB
#define MUX_IN_FLAGS					(IOPORT_MODE_MUX_B)
#define MUX_IN_GPIO						(PIO_PB14_IDX)
#define MUX_IN_PIO_ID					ID_PIOB
#define MUX_SEL_GPIO					(PIO_PB22_IDX)
#define MUX_SEL_PIO_ID					ID_PIOB
#define TTL_D_NRESET_GPIO				(PIO_PC27_IDX)
#define TTL_D_NRESET_PIO_ID				ID_PIOC
